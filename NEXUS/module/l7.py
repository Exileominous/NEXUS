...
║ {nexus}*{clear} NEXUS     {nexus}:{clear}  {nexus}[{clear}{white}LAYER7{clear}{nexus}]{clear}                             ║  
╚═════════════════════════════════════════════════════╝
               
╔═════════════════════════════════════════════════════╗
║ {nexus}[{clear}1{nexus}]{clear} HTTP Flood Attack                               ║
║ {nexus}[{clear}2{nexus}]{clear} HTTP Flood Attack {nexus}[{clear}{white}PROXY{clear}{nexus}]{clear}                       ║                       
...
def layer7():
    while True:
        logo()
        select = input(f"""
╔═══[{nexus}root{clear}@{nexus}ZOIC{clear}]
╚══{nexus}>{clear} """)
